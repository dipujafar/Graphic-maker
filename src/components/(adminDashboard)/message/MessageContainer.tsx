...
import user2Img from "@/assets/image/user2.jpg";
import user3Img from "@/assets/image/user3.png";
...
const MessageContainer = ()=> {
  return (
    <div className="lg:mx-auto ">
      <div className="relative z-10 flex flex-col rounded-xl rounded-t-xl border-t-8 border-t-[#0DB760]  px-10 py-8 lg:flex-row">
        {/* left */}
        <div className="border-opacity-[40%] pr-2 lg:w-[30%] lg:border-r-2 lg:border-gray-300">
          <div className="border-t-black flex items-end gap-x-5 border-b border-opacity-[40%] py-4 text-black">
            ...
            <p className="font-kumbh-sans  pb-1 font-semibold">
              12
            </p>
          </div>
          ...
          <div className="mt-10 flex w-full items-center gap-x-6">
            ...
            <div className="flex w-full items-stretch gap-x-4">
              ...
              size="large"
                ...
                type="text"
                className="w-full border-2 border-black/50 bg-transparent px-4 py-6"
              />
              <Button
