import { Button, DatePicker, DatePickerProps, Form, FormProps, Input, Modal } from "antd";
      ...
      <div className="pb-16">
        ...
        <div className="mt-10">
          <Form
            layout="vertical"
            onFinish={onFinish}
            initialValues={{ email: "opovai@gmail.com", order: "Logo",date: moment("2024-09-16"), }}
          >
            ...
            >
              <DatePicker onChange={onChangeDate} size="large"  style={{width: "100%"}}/>
            </Form.Item>
